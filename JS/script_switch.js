...
setTimeout(() => {
    ...
    setInterval(() => {
        ...
        (Math.floor(document.getElementById("music").currentTime / 60) && Math.floor(document.getElementById("music").currentTime % 60)) < 10 ? 
        document.getElementById("current_time_unit").innerHTML = "0"+Math.floor(document.getElementById("music").currentTime / 60) + ":" + "0"+Math.floor(document.getElementById("music").currentTime % 60) :
...
function initiateStopClock()
{
    ...
    document.getElementById("lapZone").style.display = "block";
...
function initiateClock()
{
    document.getElementById("stopclockMain").style.display = "none";
     document.getElementById("lapZone").style.display = "none";   
    document.getElementById("pomodoro").style.display = "none";
